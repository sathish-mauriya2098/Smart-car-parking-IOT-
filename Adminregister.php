...
<link href="font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body> 
       ...
       <center>
            <h2><img src="car.gif" width="130px" height="30px">Registration For Administrator</h2></center>
              <center> <div class="log">
    <form action="Admindb.php" method="post" name="form" onsubmit="return validation()">
