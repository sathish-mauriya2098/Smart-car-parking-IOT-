        ...
        6: [
            function(t, e, n) {
                ! function(t, i) {
                    ...
                    function v(t, e) {
                        var n, i, a;
                        if (o(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), o(e._i) || (t._i = e._i), o(e._f) || (t._f = e._f), o(e._l) || (t._l = e._l), o(e._strict) || (t._strict = e._strict), o(e._tzm) || (t._tzm = e._tzm), o(e._isUTC) || (t._isUTC = e._isUTC), o(e._offset) || (t._offset = e._offset), o(e._pf) || (t._pf = g(e)), o(e._locale) || (t._locale = e._locale), we.length > 0)
                            for (n = 0; n < we.length; n++) o(a = e[i = we[n]]) || (t[i] = a);
                        return t
                    }
                    ...
                    function Bt(t) {
                        for (var e in t)
                            if (-1 === Wn.indexOf(e) || null != t[e] && isNaN(t[e])) return !1;
                    ...
                    function be() {
                        ...
                        var t, e, n, i = gi(this._milliseconds) / 1e3,
                            a = gi(this._days),
                            r = gi(this._months);
                    ...
                    var De, Ce, Pe = De = Object.keys ? Object.keys : function(t) {
                            ...
                            return n
                        }, Te = {}, Ae = {}, Ie = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
                    ...
                    var kn, wn = R("Hours", !0),
                        ...
                        }, Sn = {}, Dn = {}, Cn = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
                    ...
                    Zn.add = Bn, Zn.calendar = function(t, e) {
                        ...
                        if ("object" == typeof t)
                            for (var n = F(t = I(t)), i = 0; i < n.length; i++) this[n[i].unit](t[n[i].unit]);
                    ...
                    t.controllers.bar = t.DatasetController.extend({
                        ...
                        updateElement: function(t, e, n) {
                            var i = this,
                                ...
                                o = i.getMeta(),
                                s = i.getDataset(),
                                l = t.custom || {}, u = a.options.elements.rectangle;
                        ...
                        calculateBarValuePixels: function(t, e) {
                            ...
                            if (g || void 0 === g && void 0 !== m)
                                for (n = 0; n < t; ++n)(i = u.getDatasetMeta(n)).bar && i.stack === m && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && (a = c.getRightValue(h[n].data[e]), (f < 0 && a < 0 || f >= 0 && a > 0) && (p += a));
                ...
                i._set("bubble", {
                    ...
                    t.controllers.bubble = t.DatasetController.extend({
                        ...
                        updateElement: function(t, e, n) {
                            var i = this,
                                a = i.getMeta(),
                                r = t.custom || {}, o = i.getScaleForId(a.xAxisID),
                            ...
                            generateLabels: function(t) {
                                ...
                                return e.labels.length && e.datasets.length ? e.labels.map(function(n, i) {
                                    var a = t.getDatasetMeta(0),
                                        o = e.datasets[0],
                                        s = a.data[i],
                                        l = s && s.custom || {}, u = r.valueAtIndexOrDefault,
                    ...
                    t.controllers.line = t.DatasetController.extend({
                        ...
                        updateBezierControlPoints: function() {
                            ...
                            if (s.dataset._model.spanGaps && (u = u.filter(function(t) {
                                ...
                                for (e = 0, n = u.length; e < n; ++e) i = u[e]._model, a = r.splineCurve(r.previousItem(u, e)._model, i, r.nextItem(u, e)._model, s.dataset._model.tension), i.controlPointPreviousX = a.previous.x, i.controlPointPreviousY = a.previous.y, i.controlPointNextX = a.next.x, i.controlPointNextY = a.next.y; if (o.chart.options.elements.line.capBezierPoints)
                        ...
                        labels: {
                            generateLabels: function(t) {
                                ...
                                return e.labels.length && e.datasets.length ? e.labels.map(function(n, i) {
                                    var a = t.getDatasetMeta(0),
                                        o = e.datasets[0],
                                        s = a.data[i].custom || {}, l = r.valueAtIndexOrDefault,
                    ...
                    t.DatasetController = function(t, e) {
                        ...
                        removeHoverStyle: function(t, e) {
                            var n = this.chart.data.datasets[t._datasetIndex],
                                a = t._index,
                                r = t.custom || {}, o = i.valueAtIndexOrDefault,
                                s = t._model;
                        ...
                        setHoverStyle: function(t) {
                            var e = this.chart.data.datasets[t._datasetIndex],
                                n = t._index,
                                a = t.custom || {}, r = i.valueAtIndexOrDefault,
                                o = i.getHoverColor,
                                s = t._model;
            ...
            function(t, e, n) {
                ...
                function i(t, e, n, i) {
                    ...
                    for (r = 0, o = g.length; r < o; ++r)
                        if (s = g[r], d = n[s], e.hasOwnProperty(s) || (e[s] = d), (l = e[s]) !== d && "_" !== s[0]) {
                ...
                e.exports = function(t) {
                    ...
                    t.layoutService = {
                        ...
                        update: function(t, a, r) {
                            ...
                            if (t) {
                                var l = t.options.layout || {}, u = i.options.toPadding(l.padding),
                                    d = u.left,
                                    c = u.right,
                                    h = u.top,
                                    f = u.bottom,
                ...
                i._set("global", {
                    ...
                    t.plugins = {
                        ...
                        descriptors: function(t) {
                            ...
                            var n = [],
                                a = [],
                                o = t && t.config || {}, s = o.options && o.options.plugins || {};
                            ...
                            if (i.display) {
                                ...
                                if (s.each(p, function(n, r) {
                                    if (!s.isNullOrUndef(n.label)) {
                                        ...
                                        var y, b, x, k, w, M, I, O, F, R, L = "middle",
                                            W = "middle",
                                            Y = d.padding;
                                        if (m) {
                                            var N = _ + Y;
                                    ...
                                    if (h.display && (o.save(), o.lineWidth = t.glWidth, o.strokeStyle = t.glColor, o.setLineDash && (o.setLineDash(t.glBorderDash), o.lineDashOffset = t.glBorderDashOffset), o.beginPath(), h.drawTicks && (o.moveTo(t.tx1, t.ty1), o.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (o.moveTo(t.x1, t.y1), o.lineTo(t.x2, t.y2)), o.stroke(), o.restore()), d.display) {
                                        ...
                                        var e = t.label;
                                        if (s.isArray(e))
                                            for (var n = 0, i = 0; n < e.length; ++n) o.fillText("" + e[n], 0, i), i += 1.5 * y.size;
        ...
        49: [
            function(t, e, n) {
                ...
                i._set("global", {
                    ...
                    function e(t) {
                        var e, n = t.el._model || {}, i = t.el._scale || {}, a = t.fill,
                            r = null;
                ...
                i._set("global", {
                    ...
                    return t.Legend = a.extend({
                        ...
                        buildLabels: function() {
                            var t = this,
                                e = t.options.labels || {}, n = r.callback(e.generateLabels, [t.chart], t) || [];
                        ...
                        fit: function() {
                            var t = this,
                                ...
                                m = t.minSize,
                                p = t.isHorizontal();
                            if (p ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o)
                                if (s.font = f, p) {
                    ...
                    return t.Title = a.extend({
                        ...
                        draw: function() {
                            ...
                            if (a.display) {
                                ...
                                var _ = a.text;
                                if (r.isArray(_))
                                    for (var k = 0, w = 0; w < _.length; ++w) e.fillText(_[w], 0, k, s), k += g;
            ...
            function(t, e, n) {
                ...
                e.exports = function(t) {
                    ...
                    function f(t) {
                        ...
                        var u = t.getDistanceFromCenterForValue(o.ticks.reverse ? t.min : t.max),
                            f = n(t);
                        i.textBaseline = "top";
            ...
            function(t, e, n) {
                ...
                function c(t, e, n, i) {
                    ...
                    for (a = w.indexOf(t); a < s - 1; ++a)
                        if (r = k[w[a]], o = r.steps ? r.steps[r.steps.length - 1] : _, r.common && Math.ceil((n - e) / (o * r.size)) <= i) return w[a];
                    return w[s - 1]
                }
                            ...
                            for (t = 0, n = (d.data.datasets || []).length; t < n; ++t)
                                if (d.isDatasetVisible(t))
                                    if (o = d.data.datasets[t].data, b.isObject(o[0]))
                                        for (m[t] = [], e = 0, r = o.length; e < r; ++e) s = u(o[e], l), g.push(s), m[t][e] = s;
